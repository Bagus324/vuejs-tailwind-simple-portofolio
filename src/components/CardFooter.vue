<template>
    <div>
        ...
        <div class="text-center">
            <a href="https://www.linkedin.com/in/bagus-tri-yulianto-darmawan-8923a8232/" target="_blank"
            ...
            <a href="https://github.com/Bagus324" target="_blank"
                class="m-1 p-1 text-gray-600 text-2xl hover:text-blue-600 dark:text-gray-400"> <font-awesome-icon
                    icon="fa-brands fa-github" /></a>
            <a href="mailto:bagusdarmawan654@gmail.com"
                class="m-1 p-1 text-gray-600 text-2xl hover:text-blue-600 dark:text-gray-400"> <font-awesome-icon
